...
### 众筹
由于我们作为无运作资本的志愿者组织，在组织日常运作及为具体项目购置大宗物件（如服务器，硬盘）时经常需要资金及物质支持。因此，我们采用众筹等方式，接受针对购买计划和用于组织正常运作的捐赠。

正在进行的众筹：

- [社区服务状态监测服务器续期](https://ifdian.net/project/88eb0000836511f1a7ea52540025c377)

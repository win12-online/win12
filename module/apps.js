            ...
            if (le > 0) {
                ...
                $('#search-win>.ans>.list>list').html(
					...
					setTimeout(() => {
						...
						<img src="icon/about.svg"><p>About Win12 Online</p></a>`);

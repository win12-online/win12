    ...
    mediaplayer: {
        ...
        open: (url, name, type) => {
            ...
            if (type === 'video') {
                ...
                $('.window.mediaplayer>.titbar>img').attr('src', 'assets/icons/files/vidio.png');
            } else {
                $('#mediaplayer-audio').attr('src', url).show()[0].load();
                $('#mediaplayer-video').hide()[0].pause();
                $('.window.mediaplayer>.titbar>img').attr('src', 'assets/icons/files/music.png');
            }
        },
        close: () => {
            ...
            if (le > 0) {
                ...
                $('#search-win>.ans>.list>list').html(
					...
					setTimeout(() => {
						...
						<img src="assets/icons/about.svg"><p>About Win12 Online</p></a>`);
